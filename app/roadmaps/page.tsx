                    ...
                    {roadmaps.length === 0 ? (
                        <Card className="text-center p-12">
                            <div className="flex flex-col items-center justify-center">
                                <div
                                    className="w-20 h-20 bg-purple-primary/10 rounded-full flex items-center justify-center mb-4">
                                        ...
                                        <div className="p-6 flex items-center justify-between">
                                            ...
                                            <div className="flex items-center gap-2 ml-4">
                                                <Link href={`/roadmap/${roadmap.id}/edit`}>
                                                    <button
                                                        className="p-2 rounded-lg hover:bg-purple-primary/10 transition text-text-muted hover:text-purple-light">
